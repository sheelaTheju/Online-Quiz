...
(function(){
     ...
     * uglified.
     */
    QuizController.$inject = ['quizMetrics', 'DataService','$rootScope','$scope'];
     ...
     */
    function QuizController(quizMetrics, DataService,$rootScope,$scope){
        ...
        function setActiveQuestion(){
            // no argument passed, data = undefined.
              ...
              //     console.log('1 ',vm.activeQuestion);
                //   console.log('2 ',quizLength);
                ...
                //   vm.activeQuestion = vm.activeQuestion < quizLength?++vm.activeQuestion:0;
                 ...
                 //   console.log('3 ',vm.activeQuestion);
                   //console.log('4 ',quizLength);
         ...
         */
        function questionAnswered(type,$index){
           ...
           if(type == '1'){
              ...
              vm.setActiveQuestion(i,t);
              console.log('skipped ',i);
           
             // vm.setActiveQuestion(vm.activeQuestion,t);
              //return;
                ...
                if(DataService.quizQuestions[vm.activeQuestion].selected !== null){
                    ...
                    if(numQuestionsAnswered >= quizLength){
                      ...
                      if(DataService.quizQuestions[i].selected === null){
                                //setActiveQuestion(i,t);
                      if(DataService.quizQuestions[vm.activeQuestion].selected == DataService.correctAnswers[vm.activeQuestion]){

                      }
                     else{

                        var a = DataService.quizQuestions[vm.activeQuestion].selected;
                        $("#answerCon").parent().find("div:eq("+a+")").css('background-color','#EC7063');
                     }

                        $("#answerCon").parent().find("div:eq(0)").css('background-color','#82E0AA');
                        $("#quizNextButton").text('Go To Next Question');


            
                     $scope.disableButton = false;
                     $scope.disableRadioButton = true;
                     $scope.disableSkipButton = true;
                    
                     if($scope.colorChanged){

                        console.log('setActiveQuestion b4 ',i);
                        setActiveQuestion(i,t);
                        console.log('setActiveQuestion after ',i);

                        $("#quizNextButton").text('Next');
                        ...
                        vm.error = false;
                         if(DataService.quizQuestions[vm.activeQuestion].selected == DataService.correctAnswers[vm.activeQuestion]){
                                     ...
                                     $("#answerCon").parent().find("div:eq("+a+")").css('background-color','red');
                     ...
                     if($scope.colorChanged){
                         ...
                         if(i == 5){
                          ...
                          console.log('after finaliseAnswers');
                          $scope.disableRadioButton = false;
                          //console.log('i1 ',i);
                          vm.setActiveQuestion(i,t);
                         // i += 1;
