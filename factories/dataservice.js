...
(function(){
    ...
    var correctAnswers = [0,0,0,0,0];

    var quizQuestions  = [
        {
            
            type: "text",
            text: "_______ Project Management is one of the revolutionary methods introduced for the practice of project management.",
            possibilities: [
                {
                    answer: "Agile"
                },
        ...
        {
            type: "text",
            text: "This is one of the latest project management strategies that is  applied to project management practice in _______  development.",
            possibilities: [
                {
                    answer: "Software"
                },
        ...
        {
            type: "text",
            text: "From software development as a business, there have been a number of processes following, such as the _______ model.",
            possibilities: [
        ...
        {
            type: "text",
            text: "With software development and business requirements, the _______ models are not robust enough to cater the demands.",
            possibilities: [
        ...
        {
            type: "text",
            text: "The _______ Technology community developed agile software development models.",
            possibilities: [
                {
                    answer: "Development"
                },
